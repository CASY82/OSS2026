...
def build_registry(db,llm,cfg:Settings):
    ...
    return {ToolName.VECTOR_SEARCH:VectorSearchTool(SearchService(VectorRepository(db),llm,cfg.TOP_K)),ToolName.NL2SQL:Nl2SqlTool(),ToolName.KNOWLEDGE_GRAPH:KnowledgeGraphTool(GraphService(kg_repo,resolver))}
